...
import { Search, User, Phone, Wallet, Calendar, Shield, Loader2, AlertCircle, ChevronRight } from "lucide-react";
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-500 to-orange-700 flex justify-center items-center">
        <div className="bg-white p-8 rounded-xl shadow-xl flex flex-col items-center">
          ...
          <p className="text-gray-800 font-semibold">Loading members...</p>
        </div>
      </div>
    );
  }
        ...
        <Card className="rounded-xl shadow-2xl overflow-hidden border-0 bg-white text-gray-800 relative">
          ...
          <div className="p-4 md:p-6">
                      ...
                      <div className="p-5">
                        ...
                        <div className="space-y-3 mb-4">
                          <div className="flex items-center text-gray-600">
                            ...
                            <span className="text-sm">ID: {member.memberId}</span>
                          </div>
                          ...
                          <div className="flex items-center text-gray-600">
                            ...
                            <span className="text-sm font-medium">₹{member.money.toFixed(2)}</span>
                          </div>
                        </div>
            ...
            <div className="mt-8 pt-4 border-t border-orange-100 text-center">
              <p className="text-xs text-gray-500">IPL Fan League • Team Management</p>
            </div>
          </div>
        </Card>
      </div>
